# Regridding simplification plan — detailed archive

This is the evidence-rich plan superseded by the concise executable plan at
`2026-08-21-regridding-simplification-plan.md`. It preserves the diagnosis,
benchmarks, rejected alternatives, and detailed API reasoning used to derive
that plan. The concise plan is authoritative for task order and scope.

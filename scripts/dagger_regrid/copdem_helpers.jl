# Shared CopDEM source, graph, and one-chunk execution helpers.
#
# This is an include fragment, not a module. Both copdem_production.jl and the
# isolated Dagger backend load it into their own module so they use exactly the
# same source and regridding implementation.
...
include(joinpath(SCRIPTS_DIR, "copdem_source_mode.jl"))
include(joinpath(SCRIPTS_DIR, "copdem_store.jl"))
include(joinpath(SCRIPTS_DIR, "copdem_synthetic.jl"))
include(joinpath(SCRIPTS_DIR, "copdem_policy.jl"))

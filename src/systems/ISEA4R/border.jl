...
# the quad-face family's premise, which supplies the rim, interior, and halo
# engines. A boundary cell always has an axis neighbour outside the block —
# across a diamond rim as readily as within one — so neither connectivity nor a
...
# rim cells and filters every one of them with the native one-ring.
